...
const { viewEmployees, viewEmployeesByManager, addEmployee, addEmployeePrompt , deleteEmployeePrompt,deleteEmployee} = require('./employee');
const { viewDepartments , addDepartment,addDepartmentPrompt,deleteDepartment,deleteDepartmentPrompt} = require('./deparment');
const { viewRoles, addRole, addRolePrompt, deleteRole,deleteRolePrompt } = require('./role');
